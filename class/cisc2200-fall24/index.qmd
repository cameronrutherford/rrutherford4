...
This class studies abstract data types (their specification, applicaiton and implementation) including:
...
Unless another tool is decided on, we will host discusions on Blackboard as needed.
...
Please review the [Academic Integrity Poicy of Fordham](https://www.fordham.edu/resources/policies/academic-integrity-policy/standards-of-academic-integrity/)
...
::: {.callout-warning}
Your quizes and exams will be pen and paper, so keep this in mind throughout the course.
:::
